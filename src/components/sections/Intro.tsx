...
export default function Intro() {
  return (
    <section id="about" className="relative py-24 md:py-32 bg-[#faf8f5] text-[#141418] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative aspect-[3/4] w-full rounded-md overflow-hidden border border-[#c5a059]/40 shadow-2xl shadow-[#141418]/10 group">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-4 bg-white/90 backdrop-blur-md rounded border border-[#c5a059]/30 shadow-lg text-left">
                  <p className="text-[10px] uppercase tracking-[0.25em] text-[#8f6f2d] font-mono font-medium">
                    The Art of Celebration
                  </p>
                  <p className="font-serif text-base text-[#141418] font-medium">
              ...
              <div className="absolute -top-3 -left-3 w-24 h-24 border-t-2 border-l-2 border-[#c5a059]/60 pointer-events-none rounded-tl-sm" />
            </div>
          </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-[#141418] leading-[1.2] font-normal tracking-tight">
            ...
            <div className="space-y-4 text-sm sm:text-base text-[#4a4742] font-light leading-relaxed">
              <p>
            ...
            <div className="mt-4 p-6 sm:p-7 rounded-md bg-white border border-[#c5a059]/35 shadow-xl shadow-[#141418]/05 relative overflow-hidden group">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                {/* Pranav Desai Portrait with Royal Gold Halo */}
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden border-2 border-[#c5a059] shadow-xl shrink-0 p-0.5 bg-[#faf8f5]">
                ...
                <div className="flex-1 text-center sm:text-left space-y-2">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
                    <div>
                      <h3 className="font-serif text-2xl sm:text-3xl text-[#141418] tracking-wide font-normal">
                        {SITE_CONFIG.proprietor}
                      </h3>
                      <p className="text-xs uppercase tracking-[0.22em] text-[#8f6f2d] font-semibold">
                        {SITE_CONFIG.proprietorRole}
                      </p>
                    </div>

                    <div className="inline-flex items-center justify-center gap-1.5 text-[11px] text-[#8f6f2d] bg-[#faf8f5] px-3 py-1.5 rounded-full border border-[#c5a059]/40 self-center sm:self-auto font-mono">
                  ...
                  <div className="pt-2 flex flex-wrap items-center justify-center sm:justify-start gap-4 text-xs text-[#4a4742]">
